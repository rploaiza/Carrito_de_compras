<?php 
	...
	$consulta = "select distinct p.*, e.nombre as estadop from categoria_producto c, producto p, estado e WHERE p.id_categoria=c.id and p.id_estado = e.id and c.categoria LIKE '%".$search."%' and p.marca LIKE '%".$search."%' and p.valor LIKE '%".$search."%' or c.categoria LIKE '%".$search."%' and p.id_categoria=c.id and p.id_estado = e.id or p.marca LIKE '%".$search."%' and p.id_categoria=c.id and p.id_estado = e.id or p.id_categoria=c.id and p.valor LIKE '%".$search."%' and p.id_estado = e.id ";
			...
			<span class="contenido"><?php echo  "
                    ...
                    <p style='text-align:center;'><strong>Marca: ".$fila['marca']."</strong><p>
                        <p>
                            ...
                            <strong>Estado: </strong>".$fila['estadop']."
                        </p>
