  ...
  <table class="table table-bordered">
    <tr>
      <td>
        <table class="table table-bordered table table-hover">
          ...
          while($row=mysql_fetch_array($pa)){
            ...
            <tr style="font-size:9px">
              ...
              <td>
                <a href="principal.php?del=<?php echo $row['codigo']; ?>" style="color:red;" title="Eliminar de la Lista">
        ...
        <tr>
          <a href="login.php" style="color:red;" title="Eliminar de la Lista">
             Comprar <span class="glyphicon glyphicon-check"></span>
          </a>
        </tr>
      </table>
    </div>
